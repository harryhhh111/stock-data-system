...
══════════════════════════════════════════════════
  ...
  ┌─ 调仓记录 ─────────────────────────┐
  │ 2022-01-28  买入 12 只   净值 1.000  基准 1.000  │
  │ 2022-07-29  换手 36%     净值 0.904  基准 0.914  │
  │ 2023-01-31  换手 38%     净值 0.862  基准 0.911  │
  │ 2023-07-31  换手 59%     净值 0.767  基准 0.880  │
  │ 2024-01-31  换手 50%     净值 0.717  基准 0.705  │
  │ 2024-07-31  换手 69%     净值 0.796  基准 0.754  │
  │ 2025-01-27  换手 61%     净值 0.844  基准 0.836  │
  │ 2025-07-31  换手 61%     净值 0.857  基准 0.893  │
  │ 2026-01-30  换手 66%     净值 1.276  基准 1.031  │
  │ 2026-05-29  买入 15 只   净值 1.119  基准 1.072  │
  └────────────────────────────────────┘
```
...
|------|------|------|--------|------|---------|--------|--------|---------|
| `fcf_roe_value` | CN_A | 2022-01 ~ 2026-05 | +11.9% | +2.6% | -35.9% | 0.24 | 20.6% | 8 |
| `fcf_roe_value` | CN_HK | 2022-01 ~ 2026-05 | -2.9% | -0.7% | -50.9% | 0.10 | 25.3% | 8 |
| `commodity_rotation` | CN_A | 2022-01 ~ 2026-05 | +0.0% | +0.0% | -26.7% | 0.13 | 26.5% | 53 |

> 以上结果由 `python -m quant.backtest --preset <name> --market <market> --start 2022-01 --end 2026-05` 重新生成。
>
> - ROE 阈值从 10% 上调到 12%，CN_A / CN_HK 的 `fcf_roe_value` 选股池有所收窄（平均持仓从 27/15 只降至约 18/10 只），样本期内表现较 10% 阈值略弱、较 15% 阈值明显改善。
> - 策略自身的年化/回撤/波动率/Sharpe 基于完整区间日频 NAV 计算；基准对比与策略区间已对齐。
