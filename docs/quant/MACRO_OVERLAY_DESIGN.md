...
> 最后更新：2026-06-09（v1.1 — 评审采纳：PIT 防护 / silent failure / 冲突规则 / 验证设计）
...
| 品种 | 代码 | 文档承诺覆盖 | 关联 A 股行业 | 验证状态 |
|------|------|-------------|-------------|---------|
| 黄金 | XAU | 2006-今 | 有色金属（贵金属） | ⏳ 待 Phase 0 验证 |
| WTI 原油 | CL | 1996-今 | 石油石化 | ⏳ 待 Phase 0 验证 |
| 白银 | SI | 2016-今 | 有色金属（白银） | ⏳ 待 Phase 0 验证 |
| 铜 | HG | 2016-今 | 有色金属（工业金属） | ⏳ 待 Phase 0 验证 |
| 天然气 | NG | 2016-今 | 石油石化、公用事业 | ⏳ 待 Phase 0 验证 |
| 生猪 | LH | 2019-今 | 农林牧渔（养殖） | ⏳ 待 Phase 0 验证 |
