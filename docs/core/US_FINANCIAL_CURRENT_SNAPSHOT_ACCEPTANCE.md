...
> 执行日期：2026-07-29  
> 状态：✅ 验收关闭；10 只 canary 与 10 家官方 10-K 外部抽查通过，全部美股当前个股分析已于 2026-07-29 启用
...
- 本验收随后经 10 家官方 10-K 外部抽查确认无无法解释金额差异；
- 生产已设置 `US_FINANCIAL_VERSION_CURRENT=1`，全部美股当前个股分析启用新口径；
- 无版本事实或版本装配异常时仍自动回退旧查询；
- 本次切换不包含筛选器和回测；
